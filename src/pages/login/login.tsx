                  ...
                  <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p className="small mb-0">
                        Khi đến với chúng tôi bạn sẽ được trải nghiệm những dịch vụ tối ưu nhất, những địa điểm tuyệt 
                        vời nhất, những món ăn đặc trưng với những nền văn hóa độc đáo khi bạn đặt chân đến sẽ cho bạn 
                        những kỹ niệm khó quên bên gia đình.Chúng tôi luôn mong muốn mang lại cho bạn những chuyến đi an toàn 
                        và trọn vẹn nhất. Niềm vui của bạn là sự hạnh phúc với chúng tôi.
                      </p>
                    </div>
                  </div>
                </div>
